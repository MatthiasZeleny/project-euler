...
public class FractionTests
{
    ...
    [TestCase(2, 2 * 2, 2)]
    [TestCase(3, 3 * 5, 5)]
    public void Reduce_IsNumeratorContainedByDenominator_ShouldReturnOneDividedByRest(int numerator, int denominator,
    ...
    [TestCase(2 * 2, 2, 2)]
    [TestCase(3 * 5, 3, 5)]
    public void Reduce_IsDenominatorContainedByNumerator_ShouldReturnRestDividedByOne(int numerator, int denominator,
    ...
    public void Reduce_NumeratorAndDenominatorHaveANonTrivialGreatestCommonDivisor_ShouldReturnRestDividedByOne(int numerator,
        int denominator, int reducedNumerator, int reducedDenominator)
    {
        var fraction = new Fraction(numerator, denominator);
